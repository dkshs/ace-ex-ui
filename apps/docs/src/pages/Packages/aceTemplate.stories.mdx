...
3. Rode `npx create-next-app@latest -e https://github.com/ShadowsS01/ace-ex-ui/tree/main/packages/ace-template/template my-app`, onde `my-app` é o nome do seu projeto.
